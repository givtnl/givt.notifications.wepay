...
public class WePayPayoutCompletedNotificationTrigger: WePayNotificationTrigger
{
    ...
    public WePayPayoutCompletedNotificationTrigger(GivtDatabaseContext dbContext, WePayGeneratedConfigurationWrapper configuration, IMediator mediator,
        ISlackLoggerFactory loggerFactory, ILog logger) : base(loggerFactory, logger)
    {
